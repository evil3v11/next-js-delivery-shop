    ...
    try {
      ...
      switch (simulatedResult) {
        case "success":
          ...
          break;
        case "failure":
          onError('Недостаточно средств на карте. Повторную попытку оплаты Вы можете совершить на странице "Заказы"');
          break;
        case "error":
          onError('Ошибка банка-эмитента. повторную попытку оплаты Вы можете совершить на странице "Заказы"');
          break;
      }
    } catch (e) {
