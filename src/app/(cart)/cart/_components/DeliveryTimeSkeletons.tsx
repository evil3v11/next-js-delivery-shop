const DeliveryTimeSkeletons = () => {
  return (
    <div>
      <div className="h-8 xl:h-9 bg-gray-200 rounded mb-6 w-32 animate-pulse" />
      <div className="flex flex-col gap-y-4 md:flex-row md:flex-nowrap md:gap-x-8 xl:gap-x-10">
        <div className="flex flex-col">
          <div className="h-5 bg-gray-200 rounded mb-2 w-12 animate-pulse" />
          <div className="h-12 bg-gray-200 rounded w-full md:w-38.75 animate-pulse" />
        </div>
