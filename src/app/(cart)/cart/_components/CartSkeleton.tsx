const CartSkeleton = () => {
  return (
    <div className="bg-white rounded flex shadow-cart-item animate-pulse">
      <div className="w-6 h-6 bg-gray-200 rounded absolute -top-3 left-4" />
      <div className="flex flex-row flex-wrap md:flex-row justify-between w-full md:flex-nowrap">
        <div className="flex flex-row flex-wrap md:flex-nowrap">
          <div className="w-24 h-24 bg-gray-200 rounded m-2.5" />
        ...
        <div className="flex flex-wrap justify-between items-center gap-2 w-full p-2 md:flex-nowrap 
        md:flex-col md:justify-normal md:items-end xl:flex-row xl:items-start xl:justify-end">
          ...
          <div className="w-26 h-8 bg-gray-200 rounded" />
        </div>
      </div>
    </div>
  );
