...
const PasswordResetEmail = ({ username, resetUrl }: PasswordResetProps) => {
  return (
          ...
          <Container className="bg-white rounded-md p-6 max-w-145 mx-auto">
            <Section>
              ...
              <Section className="text-center mb-6">
                <Button
                  href={resetUrl}
                  className="bg-[#70c05b] text-white px-6 py-2 rounded text-base font-medium no-underline"
                >
                  Сбросить пароль
                </Button>
              </Section>
              ...
              <Hr className="bordeer-gray-200 my-4" />
              <Text>
                С уважением,
                <br />
                Команда &quot;Северяночки&quot;
            ...
            <Section className="mt-6 pt-4 border-t border-gray-200">
              <Text className="text-xs text-gray-400 m-0 text-center leading-4">
                Северяночка
                <br />
                Россия, Новосибирск, ул. Красный проспект, 1
                <br />
                ИНН 210123456789
              </Text>
              <Text className="text-xs text-gray-400 m-0 mt-2 text-center leading-4">
