...
import type { ImageAttributesModalContentProps } from "../../_types";
...
const ImageAttributesModal = ({
  ...
  const [internalActiveTab, setInternalActiveTab] = useState<"basic" | "advanced">(activeTab);
...
export default ImageAttributesModal;
