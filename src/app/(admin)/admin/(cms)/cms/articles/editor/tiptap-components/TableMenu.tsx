...
import { EditorProps, NodeInfo } from "../../_types";

import "./../_styles/tableMenu.css";
...
const TableMenu = ({ editor }: EditorProps) => {
  ...
  useEffect(() => {
    ...
    const updateSelection = () => {
      ...
      if (hasSelectionRange) {
        ...
        const cellNodes = nodes.filter((n) => n.type === "tableCell" || n.type === "tableHeader");
