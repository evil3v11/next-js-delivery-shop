...
import { EditorProps, ImageAttributesState, ModalAttributes, SelectedImage } from "../../_types";
...
const ImageAttributes = ({ editor }: EditorProps) => {
  const [isOpen, setIsOpen] = useState(false);
  const [currentImage, setCurrentImage] = useState<ImageAttributesState | null>(null);
  const [attributes, setAttributes] = useState<ModalAttributes>({
    alt: "",
    title: "",
    width: "",
    height: "",
