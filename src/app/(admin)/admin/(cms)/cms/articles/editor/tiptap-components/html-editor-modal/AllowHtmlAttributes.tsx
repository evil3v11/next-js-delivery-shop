...
const AllowHtmlAttributes = Extension.create({
  ...
  addGlobalAttributes: () => {
    ...
    return [
      ...
      { types: ["tableCell, tableHeader"], attributes: tableCellAttributes },
      { types: ["image"], attributes: imageAttributes },
    ];
  },
});

export default AllowHtmlAttributes;
