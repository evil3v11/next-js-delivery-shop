    ...
    <div className="bg-white p-3 md:p-4 rounded border border-[#f3f2f1] mb-4 md:mb-6">
      ...
      <div className="flex flex-col md:flex-row gap-3 md:gap-4 items-center md:items-end justify-center">
        ...
        <button
          ...
          className="bg-primary text-white hover:shadow-button-default active:shadow-button-active py-2 
          px-3 md:px-4 rounded whitespace-nowrap text-sm md:text-base w-full md:w-auto duration-300 cursor-pointer"
        >
          Добавить слот
        </button>
      </div>
