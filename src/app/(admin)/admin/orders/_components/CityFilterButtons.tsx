      ...
      {cities.map((city) => {
        ...
        return (
          <button
            ...
            className={`p-2 w-auto h-10 rounded duration-300 cursor-pointer text-xs md:text-sm xl:text-base 
          ...
          >
            {city}
            <div className="text-white w-6 h-6 text-xs bg-secondary rounded flex justify-center items-center">
              {ordersCount}
            </div>
          </button>
        );
