  ...
  return (
    ...
    >
      <div className="flex justify-between items-start gap-2">
        ...
        <button
          onClick={onClose}
          className="shrink-0 w-5 h-5 rounded-full flex items-center justify-center text-main-text hover:bg-gray-200 
          duration-300 text-base font-bold cursor-pointer"
          aria-label="Закрыть"
        >
          <X className="h-3 w-3" />
        </button>
